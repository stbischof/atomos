...
public interface AtomosBundleInfo extends Comparable<AtomosBundleInfo> {
	...
	/**
	 * The location of the Atomos bundle. The location always includes the
	 * Atomos bundle's layer {@link AtomosLayer#getName() name}. This location
	 * plus the {@link #install(String) prefix} will be used as the install
	 * location of the Atomos bundle.
	 * 
	...
	/**
	 * Adapt this Atomos bundle to the specified type. For example, if running
	 * in a module layer then the module of the Atomos bundle is returned in the
	 * optional value.
	 * 
	 * @param <A>
	...
	/**
	 * Installs this Atomos bundle using the specified prefix. If the Atomos
	 * bundle is already installed then the existing bundle is returned.
	 * 
	 * @param prefix
	 * @return the installed Atomos bundle.
	 * @throws BundleException
	 *             if an error occurs installing the Atomos bundle
	 */
